...
module CommercetoolsSdk
  class Cart
    ...
    attr_accessor :total_line_item_quantity
    ...
    def self.attribute_map
      {
        ...
        'total_line_item_quantity': :totalLineItemQuantity
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::Cart` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::Cart`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:cart_state)
        self.cart_state = attributes[:cart_state]
      end
      ...
      if attributes.key?(:total_line_item_quantity)
        self.total_line_item_quantity = attributes[:total_line_item_quantity]
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        total_line_item_quantity == o.total_line_item_quantity && super(o)
    end
    ...
    def hash
      [id, version, created_at, last_modified_at, key, last_modified_by, created_by, customer_id, customer_email, anonymous_id, store, line_items, custom_line_items, total_price, taxed_price, cart_state, shipping_address, billing_address, inventory_mode, tax_mode, tax_rounding_mode, tax_calculation_mode, customer_group, country, shipping_info, discount_codes, direct_discounts, custom, payment_info, locale, delete_days_after_last_modification, refused_gifts, origin, shipping_rate_input, item_shipping_addresses, total_line_item_quantity].hash
    end
