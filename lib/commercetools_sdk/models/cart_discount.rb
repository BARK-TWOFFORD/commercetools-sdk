  ...
  class CartDiscount
    ...
    def self.openapi_types
      {
        ...
        'valid_from': :'Object',
        'valid_until': :'Object',
        'requires_discount_code': :'Object',
        'references': :'Object',
        'stacking_mode': :'Object',
        'custom': :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::CartDiscount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::CartDiscount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, name, key, description, value, cart_predicate, target, sort_order, is_active, valid_from, valid_until, requires_discount_code, references, stacking_mode, custom].hash
    end
