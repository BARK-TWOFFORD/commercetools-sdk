...
module CommercetoolsSdk
  class CustomLineItemStateTransitionMessage
    attr_accessor :id
    ...
    attr_accessor :custom_line_item_id

    attr_accessor :transition_date
    ...
    def self.attribute_map
      {
        ...
        'custom_line_item_id': :customLineItemId,
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::CustomLineItemStateTransitionMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::CustomLineItemStateTransitionMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:custom_line_item_id)
        self.custom_line_item_id = attributes[:custom_line_item_id]
      end

      if attributes.key?(:transition_date)
        self.transition_date = attributes[:transition_date]
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        custom_line_item_id == o.custom_line_item_id &&
        transition_date == o.transition_date &&
        quantity == o.quantity &&
        from_state == o.from_state &&
        to_state == o.to_state && super(o)
    end
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, sequence_number, resource, resource_version, type, resource_user_provided_identifiers, custom_line_item_id, transition_date, quantity, from_state, to_state].hash
    end
