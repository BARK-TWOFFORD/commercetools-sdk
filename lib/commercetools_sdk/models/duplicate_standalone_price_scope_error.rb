...
module CommercetoolsSdk
  class DuplicateStandalonePriceScopeError
    attr_accessor :code
    ...
    def self.openapi_types
      {
        'code': :'Object',
        'message': :'Object',
        'conflicting_standalone_price': :'Object',
        'sku': :'Object',
        'currency': :'Object',
        'country': :'Object',
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::DuplicateStandalonePriceScopeError` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::DuplicateStandalonePriceScopeError`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        valid_until == o.valid_until && super(o)
    end
    ...
    def hash
      [code, message, conflicting_standalone_price, sku, currency, country, customer_group, channel, valid_from, valid_until].hash
    end
