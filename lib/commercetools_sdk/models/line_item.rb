  ...
  class LineItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::LineItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::LineItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'product_slug')
        self.product_slug = attributes[:'product_slug']
      end
      ...
      if attributes.key?(:'line_item_mode')
        self.line_item_mode = attributes[:'line_item_mode']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          line_item_mode == o.line_item_mode &&
          custom == o.custom &&
    ...
    def hash
      [id, product_id, product_key, name, product_slug, product_type, variant, price, taxed_price, total_price, quantity, added_at, state, tax_rate, supply_channel, distribution_channel, discounted_price_per_quantity, price_mode, line_item_mode, custom, inventory_mode, shipping_details, last_modified_at].hash
    end
