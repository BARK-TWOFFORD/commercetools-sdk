...
module CommercetoolsSdk
  class MessageDeliveryPayload
    ...
    attr_accessor :payload_not_included
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::MessageDeliveryPayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::MessageDeliveryPayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:payload_not_included)
        self.payload_not_included = attributes[:payload_not_included]
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        payload_not_included == o.payload_not_included && super(o)
    end
    ...
    def hash
      [project_key, notification_type, resource, resource_user_provided_identifiers, id, version, created_at, last_modified_at, sequence_number, resource_version, payload_not_included].hash
    end
