...
module CommercetoolsSdk
  class OrderLineItemRemovedMessage
    attr_accessor :id
    ...
    attr_accessor :removed_quantity
    ...
    attr_accessor :new_taxed_price

    attr_accessor :new_price

    attr_accessor :new_shipping_detail
    ...
    def self.attribute_map
      {
        ...
        :'new_taxed_price' => :'newTaxedPrice',
        :'new_price' => :'newPrice',
        :'new_shipping_detail' => :'newShippingDetail'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::OrderLineItemRemovedMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::OrderLineItemRemovedMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'removed_quantity')
        self.removed_quantity = attributes[:'removed_quantity']
      end
      ...
      if attributes.key?(:'new_state')
        if (value = attributes[:'new_state']).is_a?(Array)
      ...
      if attributes.key?(:'new_taxed_price')
        self.new_taxed_price = attributes[:'new_taxed_price']
      end
      ...
      if attributes.key?(:'new_shipping_detail')
        self.new_shipping_detail = attributes[:'new_shipping_detail']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          removed_quantity == o.removed_quantity &&
          new_quantity == o.new_quantity &&
          new_state == o.new_state &&
          new_total_price == o.new_total_price &&
          new_taxed_price == o.new_taxed_price &&
          new_price == o.new_price &&
          new_shipping_detail == o.new_shipping_detail && super(o)
    end
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, sequence_number, resource, resource_version, type, resource_user_provided_identifiers, line_item_id, removed_quantity, new_quantity, new_state, new_total_price, new_taxed_price, new_price, new_shipping_detail].hash
    end
