...
module CommercetoolsSdk
  class OrderReturnShipmentStateChangedMessage
    attr_accessor :id
    ...
    attr_accessor :return_shipment_state
    ...
    def self.openapi_types
      {
        ...
        'return_item_id': :'Object',
        'return_shipment_state': :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::OrderReturnShipmentStateChangedMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::OrderReturnShipmentStateChangedMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:return_shipment_state)
        self.return_shipment_state = attributes[:return_shipment_state]
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        return_shipment_state == o.return_shipment_state && super(o)
    end
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, sequence_number, resource, resource_version, type, resource_user_provided_identifiers, return_item_id, return_shipment_state].hash
    end
