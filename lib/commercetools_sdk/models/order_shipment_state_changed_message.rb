...
module CommercetoolsSdk
  class OrderShipmentStateChangedMessage
    attr_accessor :id
    ...
    attr_accessor :old_shipment_state
    ...
    def self.attribute_map
      {
        ...
        'old_shipment_state': :oldShipmentState
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::OrderShipmentStateChangedMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::OrderShipmentStateChangedMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:old_shipment_state)
        self.old_shipment_state = attributes[:old_shipment_state]
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        old_shipment_state == o.old_shipment_state && super(o)
    end
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, sequence_number, resource, resource_version, type, resource_user_provided_identifiers, shipment_state, old_shipment_state].hash
    end
