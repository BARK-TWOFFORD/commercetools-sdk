...
module CommercetoolsSdk
  class OrderShippingRateInputSetMessage
    attr_accessor :id
    ...
    attr_accessor :old_shipping_rate_input
    ...
    def self.attribute_map
      {
        ...
        'old_shipping_rate_input': :oldShippingRateInput
      }
    end
    ...
    def self.openapi_types
      {
        ...
        'old_shipping_rate_input': :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::OrderShippingRateInputSetMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::OrderShippingRateInputSetMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:old_shipping_rate_input)
        self.old_shipping_rate_input = attributes[:old_shipping_rate_input]
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        old_shipping_rate_input == o.old_shipping_rate_input && super(o)
    end
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, sequence_number, resource, resource_version, type, resource_user_provided_identifiers, shipping_rate_input, old_shipping_rate_input].hash
    end
