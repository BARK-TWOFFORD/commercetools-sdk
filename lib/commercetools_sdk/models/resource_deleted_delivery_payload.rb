...
module CommercetoolsSdk
  class ResourceDeletedDeliveryPayload
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::ResourceDeletedDeliveryPayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::ResourceDeletedDeliveryPayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_erasure')
        self.data_erasure = attributes[:'data_erasure']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_erasure == o.data_erasure && super(o)
    end
    ...
    def hash
      [project_key, notification_type, resource, resource_user_provided_identifiers, version, modified_at, data_erasure].hash
    end
