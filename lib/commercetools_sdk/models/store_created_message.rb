...
module CommercetoolsSdk
  class StoreCreatedMessage
    ...
    attr_accessor :supply_channels

    attr_accessor :product_selections
    ...
    def self.openapi_types
      {
        ...
        'supply_channels': :'Object',
        'product_selections': :'Object',
        'custom': :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `CommercetoolsSdk::StoreCreatedMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `CommercetoolsSdk::StoreCreatedMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:distribution_channels)
        if (value = attributes[:distribution_channels]).is_a?(Array)
          self.distribution_channels = value
        end
      end

      if attributes.key?(:supply_channels)
        if (value = attributes[:supply_channels]).is_a?(Array)
          self.supply_channels = value
        end
      end

      if attributes.key?(:product_selections)
        if (value = attributes[:product_selections]).is_a?(Array)
          self.product_selections = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        ...
        distribution_channels == o.distribution_channels &&
        supply_channels == o.supply_channels &&
        product_selections == o.product_selections &&
    ...
    def hash
      [id, version, created_at, last_modified_at, last_modified_by, created_by, sequence_number, resource, resource_version, type, resource_user_provided_identifiers, name, languages, distribution_channels, supply_channels, product_selections, custom].hash
    end
