...
# Unit tests for CommercetoolsSdk::ErrorResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorResponse' do
  before do
    # run before each test
    @instance = CommercetoolsSdk::ErrorResponse.new
  end
  ...
  describe 'test an instance of ErrorResponse' do
    it 'should create an instance of ErrorResponse' do
      expect(@instance).to be_instance_of(CommercetoolsSdk::ErrorResponse)
    end
  end
