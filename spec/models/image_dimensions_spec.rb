...
# Unit tests for CommercetoolsSdk::ImageDimensions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImageDimensions' do
  before do
    # run before each test
    @instance = CommercetoolsSdk::ImageDimensions.new
  end
  ...
  describe 'test an instance of ImageDimensions' do
    it 'should create an instance of ImageDimensions' do
      expect(@instance).to be_instance_of(CommercetoolsSdk::ImageDimensions)
    end
  end
